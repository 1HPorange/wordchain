...
fn create_connectivity_map(words: &Vec<String>, min_overlap: usize) -> ConnectivityMap
{
...
pub fn create_connectivity_index_table(sorted_words: &Vec<String>, follower_map: &ConnectivityMap) -> ConnectivityIndexTable {
